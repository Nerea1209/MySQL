...
Nombre de proveedores separando nombre y apellidos.
*/
use bdalmacen;
...
/* ejer 3 relacion 6*/
/*Obtener un procedimiento que obtenga el salario de los empleados incrementado en un 5%. 
...
/* Ejercicio 6 */
/*
Para la base de datos “EMPRESA_CLASE” obtener el día que termina el periodo de prueba de un empleado, 
...
/* Ejercicio 7*/
/*
Nuestro sistema MS Sql Server tiene como primer día de la semana el domingo. 
Cámbialo al lunes. Obtén el nombre del primer día de la semana del sistema.
Como nuestro sistema es MySQL, veamos como hacerlo para MySQL
*/
/*********** ACLARACIÓN  ***************/
/*
